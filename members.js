...
const MEMBERS = [
  {
    ...
    education:
      "Bachelor of Software Engineering | University of Lay Adventists of Kigali, Rwanda (Expected Graduation: 2027)",
  ...
  },
  {
    ...
    projects: [
      {
        name: "Void Media — Social Media Platform",
        url: "https://void-media-lynj.onrender.com",
      },
...
function makeTags(items, colorStyle) {
  ...
  return items
    .map(
      (item) => `<span class="skill-tag" style="${colorStyle}">${item}</span>`,
    )
    .join("");
}
